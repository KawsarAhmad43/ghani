            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <button
                onClick={(e) => {
                  ...
                  navigator.clipboard.writeText(shareUrl).then(() => toast?.success ? toast.success('লিংক কপি করা হয়েছে!') : alert('লিংক কপি করা হয়েছে!'));
                }}
                className="w-14 border-2 border-outline-variant text-on-surface-variant flex items-center justify-center rounded-xl hover:bg-surface-variant transition-all"
                title="Share Product"
              >
