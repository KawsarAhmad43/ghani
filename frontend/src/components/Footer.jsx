          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              {settingsLoaded ? (
                ...
                <div className="w-10 h-10 rounded-full border-2 border-white bg-white/20 animate-pulse"></div>
              )}
              <div>
            ...
            {settings.trade_license && (
              <p className="text-xs text-white mt-3 font-semibold bg-black/20 p-2 rounded inline-block">
